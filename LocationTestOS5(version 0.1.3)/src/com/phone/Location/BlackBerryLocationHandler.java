...
public class BlackBerryLocationHandler extends Thread{
	...
	public final String NMEA_MIME = "application/X-jst179-location-nmea";
	...
	public String isRoaming()
	{
		...
		if(RadioInfo.getNetworkService(RadioInfo.getActiveWAFs()) == RadioInfo.NETWORK_SERVICE_ROAMING ||
				RadioInfo.getNetworkService(RadioInfo.getActiveWAFs()) == RadioInfo.NETWORK_SERVICE_ROAMING_OFF_CAMPUS)
		{
			roaming = true; 
		}
		else
